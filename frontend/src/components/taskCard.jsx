...
export default function TaskStatusModal({ status, onClose, onRetry }) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex justify-center items-center z-50 p-4">
        <div className="bg-white rounded-lg max-w-md w-full p-6 border border-blue-400 shadow-md text-center">
          {status === "loading" && (
            <>
